...
//     version 1.20.0
//     from Assets/Scripts/Result/Result.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Result/Result.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ResultInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@ResultInput()
    {
        UnityEngine.Debug.Assert(!m_Result.enabled, "This will cause a leak and performance issues, ResultInput.Result.Disable() has not been called.");
    }
    ...
    {
        private @ResultInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ResultActions(@ResultInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
