...
//     version 1.20.0
//     from Assets/Scripts/Title/Title.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Title/Title.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TitleInput: IInputActionCollection2, IDisposable
{
    ...
    ~@TitleInput()
    {
        UnityEngine.Debug.Assert(!m_Title.enabled, "This will cause a leak and performance issues, TitleInput.Title.Disable() has not been called.");
    }
    ...
    public struct TitleActions
    {
        ...
        /// </summary>
        public TitleActions(@TitleInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
